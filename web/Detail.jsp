                    ...
                    <div class="col-sm-3">
                        <div class="card bg-light mb-3">
                            ...
                            <c:forEach items="${listcc}" var="o">
                                <li class="list-group-item text-white"><a href="#">${o.categoryName}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                    <div class="card bg-light mb-3">
...
<!--                                                        <select class="form-control form-control-sm" style="width:70px;">
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.user}">
                                <a href="cart?service=add2Cart&pID=${p.productID}" class="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                            </c:when>
                            <c:otherwise>
